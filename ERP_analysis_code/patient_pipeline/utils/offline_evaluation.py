...
# evaulation method added from Jan's example_toeplitz_lda_simple.py (from https://github.com/jsosulski/toeplitzlda)
...
from utils.feature_extraction_v2 import get_jumping_means, epoch_vectorizer_channelprime
